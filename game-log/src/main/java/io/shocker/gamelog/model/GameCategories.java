...
public class GameCategories {
    ...
    protected List<GameCategories.GameCategory> category;
     ...
     * {@link GameCategories.GameCategory }
     *
     *
     */
    public List<GameCategories.GameCategory> getCategory() {
        if (category == null) {
            category = new ArrayList<GameCategories.GameCategory>();
        }
